...
\textbf{Feasibility Verification.} Across all synthetic experiments, our algorithm maintains strong tube compliance within numerical tolerances. Table~\ref{tab:feasibility} shows tube-excess results for different problem sizes.

\begin{table}[htbp]
\centering
\caption{Tube-excess results on synthetic data}
\label{tab:feasibility}
\begin{tabular}{l c c c}
\hline
\textbf{Problem Size} $N$ & \textbf{Max Tube Excess} (rad) & \textbf{Avg Tube Excess} (rad) & \textbf{Feasibility Rate} \\
\hline
